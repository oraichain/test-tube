...
require (
	...
	github.com/CosmosContracts/juno/v18/x/globalfee v0.0.0-00010101000000-000000000000 // indirect
	...
	github.com/cosmos/ibc-apps/modules/ibc-hooks/v8 v8.0.0-20240705203905-bd592a21cacf // indirect
...
replace (
	// BlockInfo is rename to Info in cosmossdk.io/core v0.12.0
	cosmossdk.io/core => cosmossdk.io/core v0.11.0
	// fork wasmd so that we have legacy wasm types
	github.com/CosmWasm/wasmd => github.com/oraichain/wasmd v0.31.1-0.20241103231211-a2418b684cac
	...
	github.com/evmos/ethermint => github.com/oraichain/ethermint-cosmos-0.50 v0.0.0-20241008203017-5c93ffb2f30f
